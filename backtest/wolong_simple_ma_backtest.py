...
CONFIG.update(
    {
        ...
        "benchmark_code": "",
        "report_name": "wolong_simple_ma_backtest",
        "strategy_name": "卧龙电驱双均线专版",
        "strategy_brief": "sh.600580历史节奏增强版",
    }
)

TEST_CASES = [{"code": WOLONG_CODE, "label": "卧龙电驱（专版）", "required_codes": [WOLONG_CODE]}]


def validate_config(config: dict[str, Any]) -> None:
    validate_v2_config(config)
    validate_specialized_code(config, WOLONG_CODE, "卧龙电驱")
